...
class TitikLongsorSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $data = [
            ...
            [
                'koordinat'        => DB::raw("ST_GeomFromText('POINT(-5.1550 104.0760)', 4326)"),
            ...
            [
                'koordinat'        => DB::raw("ST_GeomFromText('POINT(-5.1470 104.1040)', 4326)"),
            ...
            [
                'koordinat'        => DB::raw("ST_GeomFromText('POINT(-5.1650 104.0870)', 4326)"),
            ...
            [
                'koordinat'        => DB::raw("ST_GeomFromText('POINT(-5.1050 104.1310)', 4326)"),
            ...
            [
                'koordinat'        => DB::raw("ST_GeomFromText('POINT(-5.1580 104.0955)', 4326)"),
